...
with sync_playwright() as p:
    ...
    links = page.query_selector_all('a[target="_blank"][rel="noopener noreferrer"][class="whitespace-nowrap text-sm hover:text-blue-500 dark:hover:text-blue-400 hover:underline"]')
